...
class SelectASCKeys extends HookConsumerWidget {
  const SelectASCKeys({
    super.key,
  ...
  final Signal<String> issuerId;
  final Signal<String> keyId;
  final Signal<String> keyBase64;
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                issuerId.value = issuerIdEditingController.text;
                keyId.value = keyIdEditingController.text;
                keyBase64.value = keyFileBase64EditingController.text;
