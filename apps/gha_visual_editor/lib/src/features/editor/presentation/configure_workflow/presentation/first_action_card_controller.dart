...
part 'first_action_card_controller.g.dart';

@riverpod
class FirstActionCardController extends _$FirstActionCardController {
  @override
  ConfigureFirstActionDomain build() {
    return const ConfigureFirstActionDomain();
  }

  void updateWorkflow(String newValue) {
    state = state.copyWith(
      workflow: ConfigureFirstActionDomainWorkflow(value: newValue),
    );
  }

  void updateRun(String newValue) {
    state = state.copyWith(
  ...
  void updateBuildMachine(String newValue) {
    state = state.copyWith(
