...
import 'package:openci_cli/src/command_runner.dart';
...
void main() {
  group('OpenciCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late OpenciCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = OpenciCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = OpenciCliCommandRunner();
