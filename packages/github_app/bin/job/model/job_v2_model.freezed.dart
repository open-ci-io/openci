...
class _$BuildStatusImpl implements _BuildStatus {
  const _$BuildStatusImpl(
      {this.processing = false, this.failure = false, this.success = false});
...
abstract class _BuildStatus implements BuildStatus {
  const factory _BuildStatus(
      {final bool processing,
      final bool failure,
      final bool success}) = _$BuildStatusImpl;
...
JobV2Model _$JobV2ModelFromJson(Map<String, dynamic> json) {
  return _JobV2Model.fromJson(json);
}
...
mixin _$JobV2Model {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $JobV2ModelCopyWith<JobV2Model> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $JobV2ModelCopyWith<$Res> {
  factory $JobV2ModelCopyWith(
          JobV2Model value, $Res Function(JobV2Model) then) =
      _$JobV2ModelCopyWithImpl<$Res, JobV2Model>;
  @useResult
  $Res call(
...
/// @nodoc
class _$JobV2ModelCopyWithImpl<$Res, $Val extends JobV2Model>
    implements $JobV2ModelCopyWith<$Res> {
  _$JobV2ModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$JobV2ModelImplCopyWith<$Res>
    implements $JobV2ModelCopyWith<$Res> {
  factory _$$JobV2ModelImplCopyWith(
          _$JobV2ModelImpl value, $Res Function(_$JobV2ModelImpl) then) =
      __$$JobV2ModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {BuildStatus buildStatus,
...
/// @nodoc
class __$$JobV2ModelImplCopyWithImpl<$Res>
    extends _$JobV2ModelCopyWithImpl<$Res, _$JobV2ModelImpl>
    implements _$$JobV2ModelImplCopyWith<$Res> {
  __$$JobV2ModelImplCopyWithImpl(
      _$JobV2ModelImpl _value, $Res Function(_$JobV2ModelImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$JobV2ModelImpl implements _JobV2Model {
  const _$JobV2ModelImpl(
  ...
  factory _$JobV2ModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$JobV2ModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'JobV2Model(buildStatus: $buildStatus, branch: $branch, githubChecks: $githubChecks, github: $github, documentId: $documentId, platform: $platform, workflowId: $workflowId, createdAt: $createdAt)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$JobV2ModelImplCopyWith<_$JobV2ModelImpl> get copyWith =>
      __$$JobV2ModelImplCopyWithImpl<_$JobV2ModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$JobV2ModelImplToJson(
      this,
    );
  }
}

abstract class _JobV2Model implements JobV2Model {
  const factory _JobV2Model(
      ...
      @TimestampConverter() final Timestamp? createdAt}) = _$JobV2ModelImpl;

  factory _JobV2Model.fromJson(Map<String, dynamic> json) =
      _$JobV2ModelImpl.fromJson;
